        ...
        data() {
            return {
                ...
                adjectives: [
                    ...
                    'bleeding','undercut','canine','crescent-shaped','kinky','stabbing','unmentionable',
                    ...
                    'spiky','hysteric','light-blue','moon','unwanted','devilish','staring','stacked','thumping','peaked',
                    'beefy','undocumented','open-minded','millennial','hippie','whacked','light-headed','rolling','Disneyland',
                    'oversized','amble','Blessed','repetitive','open-eyed','drugged','chummy','coyote',
                    ...
                    'fluffy','ginger','pumpkin-spiced','twitching','slimy','all-American','Mr','average','pricey',
                    'clumsy','unexpected','kissing','unimaginable','freaky','mysterious','exploding','devestating',
                    'strange','splendid','awesome','bezerk','unstoppable','amazing','painful','furious','spiteful',
                    'good-looking','magic','cute','enclosed','captured','catastrophic','evil','colossal','hoisin crispy'
                ],
                nouns: [
                    ...
                    'Beans','Balloon','Bear','Blanket','Blouse','Bed','Bow','Bread','Black','Board','Bones','Bill',
                    ...
                    'Bridge','Boat','Bouncer','Baby','Bunny','Car','Cargo','Car-wash','Cow','Cap','Cooker','Cheeks',
                    ...
                    'Egg','Elf','Elephant','Earrings','Ears','Englishman','Eyes','Estate','Finger','Fox','Flamingo',
                    ...
                    'Panda','Pants','Palm','Pamphlet','Pasta','Pumpkin','Pharmacist','Potato','Parfume','Panther','Pad','Pencil',
                    ...
                    'Salt','Santa','Sausages','Shark','Sandals','Shoulder','Spoon','Soap','Sand','Sheep','Sari','Stomach','Stairs','Soup',
                ...
                prefixes: [
                   ...
                   'Fairly', 'My', 'My very own','Old','Rather','Literally', 'Yes, I\'m a','Time for','Non-'
                ],
                suffixes: [
                    'at night','uncensored','with bells on','uncovered','Ltd','and co',
                    'in 2050', 'at last', '(FREE!!)', 'only $8.99', '- on sale now','- the hero we deserve', '- my hero',
