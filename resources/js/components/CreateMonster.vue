    ...
    export default {
        ...
        data() {
            return {
                ...
                nouns: [
                    'Apple','Air','Conditioner','Airport','Ambulance','Aircraft','Apartment','Arrow',
                    'Antlers','Apro','Alligator','Architect','Ankle','Armchair','Aunt','Ball','Bermudas',
                    ...
                    'Bridge','Boat','Car','Cow','Cap','Cooker','Cheeks','Cheese','Credenza','Carpet','Crow',
                    'Crest','Chest','Chair','Candy','Cabinet','Cat','Coffee','Children','Cookware','Chaise longue',
                    'Chicken','Casino','Cabin','Castle','Church','Cafe','Cinema','Choker','Cravat','Cane','Costume',
                    'Cardigan','Chocolate','Crib','Couch','Cello','Cashier','Composer','Cave','Country','Computer',
                    'Canoe','Clock','Charlie (U.K)','Dog','Deer','Donkey','Desk','Desktop','Dress','Dolphin','Doctor',
                    'Dentist','Drum','Dresser','Designer','Detective','Daughter','Egg','Elephant','Earrings','Ears',
                    'Eyes','Estate','Finger','Fox','Frock','Frog','Fan','Freezer','Fish','Film','Foot','Flag','Factory',
                    'Father','Farm','Forest','Flower','Fruit','Fork','Grapes','Goat','Gown','Garlic','Ginger','Giraffe',
                    'Gauva','Grains','Gas station','Garage','Gloves','Glasses','Gift','Galaxy','Guitar','Grandmother',
                    'Grandfather','Governor','Girl','Guest','Hamburger','Hand','Head','Hair','Heart','House','Horse',
                    'Hen','Horn','Hat','Hammer','Hostel','Hospital','Hotel','Heels','Herbs','Host','Jacket','Jersey',
                    'Jewelry','Jaw','Jumper','Judge','Juicer','Keyboard','Kid','Kangaroo','Koala','Knife','Lemon','Lion',
                    'Leggings','Leg','Laptop','Library','Lamb','London','Lips','Lung','Lighter','Luggage','Lamp','Lawyer',
                    'Mouse','Monkey','Mouth','Mango','Mobile','Milk','Music','Mirror','Musician','Mother','Man','Model',
                    ...
                    'Salt','Shark','Sandals','Shoulder','Spoon','Soap','Sand','Sheep','Sari','Stomach','Stairs','Soup',
                    ...
                    'Street','Supermarket','Swimming pool','Star','Sky','Sun','Spoon','Ship','Smile','Table','Turkey',
                    ...
                    'Town','Toothbrush','Tree','Toy','Tissue','Telephone','Underwear','Uncle','Umbrella','Vest','Voice',
                    'Veterinarian','Villa','Violin','Village','Vehicle','Vase','Wallet','Wolf','Waist','Wrist','Water melon',
                    'Whale','Water','Wings','Whisker','Watch','Woman','Washing machine','Wheelchair','Waiter','Wound','Xylophone',
                    'Zebra','Zoo'
                ],
                prefixes: [
                   'I can\'t believe it\'s not', 'Look- it\'s', 'Here comes', 'Looks like', 'Where\'s the', 'Very', 'Extremely',
                   'Fairly', 'My', 'My very own'
                ],
                suffixes: [
                    'the third','at midnight','uncensored','with bells on','uncovered','Ltd','and co', 'at last',
